    ...
    <div className="absolute w-full left-1/2 bottom-16 sm:bottom-24 translate-x-[-50%] z-30">
      {notifications > 0 ? (
        ...
        <div
          ...
          className="w-8 h-8 sm:w-10 hm:10 bg-primary rounded-full justify-center items-center flex mx-auto border border-border cursor-pointer hover:scale-110 transition-all text-white"
        >
          <ArrowDown />
        </div>
      )}
